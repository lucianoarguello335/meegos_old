...
public class AdaptadorListaHistorial extends CursorAdapter {
	private int dias;
	public AdaptadorListaHistorial(Context context, Cursor c,
			boolean autoRequery) {
	...
	public ViewHolder getItemDeLaLista(int position) {
		...
		if (cursor.getInt(4) == 1) {
			...
			holder.tipoAccion.setText("MeeGos");
		}
		...
		fecha.setTimeInMillis(cursor.getLong(2)*1000);
